...
CCB 8.6.7 inclut le code source Flutter de CCB Mobile dans [`mobile/`](../mobile/) et publie l’APK Android via GitHub Releases :

- [Télécharger l’APK CCB Mobile v8.6.7](https://github.com/SeemSeam/claude_codex_bridge/releases/download/v8.6.7/ccb-mobile-v8.6.7.apk)
...
<p align="center">
  <img src="../assets/weixin.png?v=0a86422d" alt="Groupe WeChat" width="240">
</p>
