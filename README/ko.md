...
CCB 8.6.7은 Flutter CCB Mobile 소스를 [`mobile/`](../mobile/)에 포함하며 Android APK를 GitHub Releases로 배포합니다.

- [CCB Mobile v8.6.7 APK 다운로드](https://github.com/SeemSeam/claude_codex_bridge/releases/download/v8.6.7/ccb-mobile-v8.6.7.apk)
...
<p align="center">
  <img src="../assets/weixin.png?v=0a86422d" alt="WeChat 그룹" width="240">
</p>
