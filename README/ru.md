...
CCB 8.6.7 включает Flutter source CCB Mobile в [`mobile/`](../mobile/) и публикует Android APK через GitHub Releases:

- [Скачать CCB Mobile v8.6.7 APK](https://github.com/SeemSeam/claude_codex_bridge/releases/download/v8.6.7/ccb-mobile-v8.6.7.apk)
...
<p align="center">
  <img src="../assets/weixin.png?v=0a86422d" alt="Группа WeChat" width="240">
</p>
