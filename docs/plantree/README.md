...
| [windows-native-release](plans/windows-native-release/README.md) | Published; qualification open | CCB v8.6.7 continues the stable release lanes with an isolated Windows x64 beta artifact; real Windows GUI/provider qualification remains open. |
