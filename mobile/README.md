...
CCB Mobile v8.6.12 is published as an Android APK:

- [Download ccb-mobile-v8.6.12.apk](https://github.com/SeemSeam/claude_codex_bridge/releases/download/v8.6.12/ccb-mobile-v8.6.12.apk)
...
iOS/iPadOS remain source-supported targets, but v8.6.12 release validation is
Android-focused.
